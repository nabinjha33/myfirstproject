...
export default function FastDrillBrand() {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      console.error('Failed to load FastDrill brand data:', error);
    }
    setIsLoading(false);
  };
  ...
  const ProductCard = ({ product }: { product: any }) => (
    <Card className="h-full overflow-hidden hover:shadow-xl transition-all duration-300 group">
      <div className="relative h-48 overflow-hidden bg-gray-100">
        ...
        <Badge className="absolute top-3 left-3 bg-blue-600 text-white">FastDrill</Badge>
        {product.featured && (
      ...
      <CardContent className="p-4">
        ...
        {product.variants && product.variants.length > 0 && (
          <div className="flex flex-wrap gap-1 mb-3">
            {product.variants.slice(0, 3).map((variant: any, index: number) => (
              <span
                key={index}
                className="text-xs px-2 py-1 bg-blue-50 text-blue-600 border border-blue-200 rounded"
              >
        ...
        <p className="text-gray-600 mb-3 text-sm line-clamp-2">
          {product.description || 'High-quality FastDrill product for professional use.'}
        </p>
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-400">/</span>
            <span className="text-blue-600 font-semibold">FastDrill</span>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="flex items-center gap-6 mb-6">
                {brandData?.logo && (
                  <div className="w-20 h-20 bg-white rounded-xl p-3">
                    <img src={brandData.logo} alt="FastDrill" className="w-full h-full object-contain" />
                  </div>
                )}
                <div>
                  <h1 className="text-4xl md:text-6xl font-bold mb-2">FastDrill</h1>
                  <p className="text-xl text-blue-200">Professional Power Tools</p>
                </div>
              </div>
              
              <p className="text-lg text-blue-100 mb-8 leading-relaxed">
                {brandData?.description || 'FastDrill delivers high-performance power tools designed for professionals and serious DIY enthusiasts. Built for durability, precision, and reliability.'}
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center">
                <Package className="w-8 h-8 text-blue-300 mx-auto mb-3" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              FastDrill <span className="text-blue-600">Products</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Discover our complete range of professional-grade FastDrill power tools and accessories.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
            <div className="flex flex-col lg:flex-row gap-4">
              <div className="flex-1 relative">
                ...
                <Input
                  type="text"
                  placeholder="Search FastDrill products..."
                  value={searchQuery}
            ...
            <div className="text-center py-16">
              ...
              <p className="text-gray-600 mb-6">
                {searchQuery || categoryFilter !== 'All' ?
                  ...
                  'No FastDrill products are currently available'
                }
              </p>
              {(searchQuery || categoryFilter !== 'All') && (
                <Button
      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Ready to Partner with FastDrill?
          </h2>
